...
// ----- Home -----
// Contains a full-height hero image with a frosted glass
// text band overlaid in the centre. The hero stretches 
// to fill all space between the navbar and the footer 
// (no white gap)
function Home() {
    return (
            ...
            <div className="hero-wrap">
                ...
                <div className="hero-glass">
                    ...
                    <p className="hero-sub">
                        ...
                        ourselves on giving the best haircuts for the lowest prices!
                    </p>
